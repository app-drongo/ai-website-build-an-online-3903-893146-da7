...
export default function HomeCta1() {
  const stats = [
    ...
    { value: '2,500+', label: 'Unique Pieces', icon: Sparkles },
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in leading jewelry publications
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Every piece crafted by skilled artisans with passion
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Quality assurance with lifetime craftsmanship warranty
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Custom engravings and bespoke designs available
              </p>
            </div>
          </div>
        </div>
