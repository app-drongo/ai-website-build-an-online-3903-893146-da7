...
export default function ProductCatalogPageheader1() {
  return (
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground">
                Explore 12 exquisite handcrafted pieces featuring rare gemstones and precious
          ...
          <div className="flex flex-wrap gap-4 mt-6 pt-6 border-t">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">12</span> Unique Pieces Available
              </span>
            </div>
